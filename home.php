...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    <li  style=" color:blue; font-weight:bold;" class="active"><a data-toggle="tab" href="#home">Home</a></li>
    <li  style="color:blue; font-weight:bold;"><a data-toggle="tab" href="#menu1">Profile</a></li>
    
    <li style="float:right; color:blue; font-weight:bold;"><a data-toggle="tab" href="#menu3">Logout</a></li>
  </ul>
